...
namespace EnhancedFramework.Core {
    ...
    public class EnhancedAudioPlayer : EnhancedPoolableObject, IHandle {
        ...
        private void UpdateVolume() {
            ...
            for (int i = 0; i < volumeModifiers.Count; i++) {

                Pair<AudioPlayerModifier, float> _pair = volumeModifiers[i];
        ...
        private void UpdatePitch() {
            ...
            for (int i = 0; i < pitchModifiers.Count; i++) {

                Pair<AudioPlayerModifier, float> _pair = pitchModifiers[i];
                _pitch *= _pair.Second;
            }
