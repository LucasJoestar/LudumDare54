...
namespace EnhancedFramework.Core {
    /// <summary>
    /// Utility <see cref="Component"/> used to easily mute / unmute and audio group.
    /// </summary>
    [ScriptGizmos(false, true)]
    [AddComponentMenu(FrameworkUtility.MenuPath + "Audio/Mute Audio Group"), DisallowMultipleComponent]
    public class MuteAudioGroup : EnhancedBehaviour {
        ...
        [SerializeField, Enhanced, ShowIf("useFadingObject"), Required] private FadingObjectBehaviour fadingObject = null;
        ...
        private void Mute(bool _isMute) {
            ...
            if (!(audioOption.Option is AudioVolumeOption _audioOption)) {
