...
namespace EnhancedFramework.Core {
    ...
    public class AspectRatioEnforcer : EnhancedSingleton<AspectRatioEnforcer> {
        #region Mask
        private class DisplayMask {
            ...
            public void SetLetterbox(float viewportHeight, float maskHeight, float viewportIncet) {
                Mask1.Set(0f, 0f, Screen.width, maskHeight);
                Mask2.Set(0f, maskHeight + viewportHeight, Screen.width, maskHeight);
                Viewport.Set(0f, viewportIncet / 2f, 1f, 1f - viewportIncet);
            }

            public void SetPillarbox(float viewportWidth, float maskWidth, float viewportIncet) {
                Mask1.Set(0f, 0f, maskWidth, Screen.height);
                Mask2.Set(maskWidth + viewportWidth, 0f, maskWidth, Screen.height);
                Viewport.Set(viewportIncet / 2f, 0f, 1f - viewportIncet, 1f);
            }
